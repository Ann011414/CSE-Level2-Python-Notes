...
#注意：读取的时候是有一个指针，如果已经读到后面了，指针就变到后面了
...
"""
path="D:/IDLE练习/testFile/test_11_new.txt"
f=open(path,"w",encoding="utf-8")
f.write("你好你好啊啊啊啊\n")
f.write("以前怎么没见过你啊\n")
f.close()

path="D:/IDLE练习/testFile/test_11_new2.txt"
f=open(path,"w",encoding="utf-8") #w是覆盖写 a是追加写
f.writelines(["你好你好啊啊啊啊\n","hello world\n"]) #注意里面是列表！！！
f.close()
"""
注意文件路径中斜杠的写法：
正确写法 
path1 = "D:\\PythonTest\\a.txt" 
path2 = r"D:\PythonTest\a.txt" 
path3 = "D:/PythonTest/a.txt" 
path4 = "D://PythonTest//a.txt" 
错误写法 
path_wrong = "D:\PythonTest\a.txt"
